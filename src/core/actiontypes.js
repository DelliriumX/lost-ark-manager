...
export const TOKEN_RESEND_REQUEST_STARTED = 'TOKEN_RESEND_REQUEST_STARTED' // Client requested a new registration token
export const TOKEN_RESEND_REQUEST_FAILED = 'TOKEN_RESEND_REQUEST_FAILED' // Server responded with a token sent message
export const TOKEN_RESEND_REQUEST_SUCCEEDED = 'TOKEN_RESEND_REQUEST_SUCCEEDED' // Server responded with an error to a token request
export const PASSWORD_VERIFICATION_REQUESTED = 'PASSWORD_VERIFICATION_REQUESTED'
export const PASSWORD_VERIFICATION_CANCELED = 'PASSWORD_VERIFICATION_CANCELED'
export const PASSWORD_VERIFICATION_STARTED = 'PASSWORD_VERIFICATION_STARTED'
export const PASSWORD_VERIFICATION_SUCCEEDED = 'PASSWORD_VERIFICATION_SUCCEEDED'
export const PASSWORD_VERIFICATION_FAILED = 'PASSWORD_VERIFICATION_FAILED'
export const USER_INVITATION_REQUEST_STARTED = 'USER_INVITATION_REQUEST_STARTED'
export const USER_INVITATION_REQUEST_FAILED = 'USER_INVITATION_REQUEST_FAILED'
export const USER_INVITATION_REQUEST_SUCCEEDED = 'USER_INVITATION_REQUEST_SUCCEEDED'
export const PASSWORD_RECOVERY_REQUEST_STARTED = 'PASSWORD_RECOVERY_REQUEST_STARTED'
export const PASSWORD_RECOVERY_REQUEST_SUCCEEDED = 'PASSWORD_RECOVERY_REQUEST_SUCCEEDED'
export const PASSWORD_RECOVERY_REQUEST_FAILED = 'PASSWORD_RECOVERY_REQUEST_FAILED'
export const PASSWORD_RECOVERY_TOKEN_VALIDATION_STARTED = 'PASSWORD_RECOVERY_TOKEN_VALIDATION_STARTED'
export const PASSWORD_RECOVERY_TOKEN_VALIDATION_SUCCEEDED = 'PASSWORD_RECOVERY_TOKEN_VALIDATION_SUCCEEDED'
export const PASSWORD_RECOVERY_TOKEN_VALIDATION_FAILED = 'PASSWORD_RECOVERY_TOKEN_VALIDATION_FAILED'
export const PASSWORD_RESET_REQUEST_STARTED = 'PASSWORD_RESET_REQUEST_STARTED'
export const PASSWORD_RESET_REQUEST_SUCCEEDED = 'PASSWORD_RESET_REQUEST_SUCCEEDED'
...
export const DATASET_SELECTED = 'DATASET_SELECTED' // User selected a dataset
...
export const TRANSFORMATION_SELECTED = 'TRANSFORMATION_SELECTED' // User selected a transformation
...
export const TRAINING_SELECTED = 'TRAINING_SELECTED' // User selected a training
export const TRAINING_INSPECTED = 'TRAINING_INSPECTED' // User selected a training
...
export const SCORING_SELECTED = 'SCORING_SELECTED' // User selected a scoring
export const SCORED_DATASET_SELECTED = 'SCORED_DATASET_SELECTED' // User selected a scored dataset
...
export const PIPELINE_CONFIG_BOX_SPEC_UPDATED = 'PIPELINE_CONFIG_BOX_SPEC_UPDATED' // User updated the spec of a specific box <-- remove later
export const PIPELINE_BOX_CONFIG_UPDATED = 'PIPELINE_BOX_CONFIG_UPDATED' // User updated the config of a specific box
...
export const UPLOAD_CONFIGURATION_STARTED = 'UPLOAD_CONFIGURATION_STARTED' // User opened the upload file configuration modal
export const UPLOAD_CONFIGURATION_FINISHED = 'UPLOAD_CONFIGURATION_FINISHED' // User updated the upload file configuration (prepared for upload)
export const UPLOAD_ENTITY_REMOVED = 'UPLOAD_ENTITY_REMOVED' // User removed an upload entity
export const FILE_STATE_INSPECTOR_DIALOG_TOGGLED =
  'FILE_STATE_INSPECTOR_DIALOG_TOGGLED' // User toggled the file state inspector dialog
...
export const RESOURCE_PREPARATION_REQUEST_STARTED = 'RESOURCE_PREPARATION_REQUEST_STARTED' // Resource preparation request was initiated
export const RESOURCE_PREPARATION_REQUEST_FAILED = 'RESOURCE_PREPARATION_REQUEST_FAILED' // Resource preparation was not prepared due to an error
export const RESOURCE_DATA_PREPARATION_REQUEST_SUCCEEDED = 'RESOURCE_DATA_PREPARATION_REQUEST_SUCCEEDED' // Resource data was prepared and is ready for use in the view service
export const RESOURCE_CHART_PREPARATION_REQUEST_SUCCEEDED = 'RESOURCE_CHART_PREPARATION_REQUEST_SUCCEEDED' // Resource charts was prepared and is ready for use in the view service
export const RESOURCE_DATA_PREPARATION_EXPIRED = 'RESOURCE_DATA_PREPARATION_EXPIRED' // Prepared resource data has expired 
export const RESOURCE_CHART_PREPARATION_EXPIRED = 'RESOURCE_CHART_PREPARATION_EXPIRED' // Prepared resource charts data has expired
export const RESOURCE_REQUEST_META_FETCH_STARTED = 'RESOURCE_REQUEST_META_FETCH_STARTED' // Resource request data fetch request was initiated
export const RESOURCE_REQUEST_META_FETCH_SUCCEEDED = 'RESOURCE_REQUEST_META_FETCH_SUCCEEDED' // Resource request data was successfuly fetched from the server
export const RESOURCE_REQUEST_META_FETCH_FAILED = 'RESOURCE_REQUEST_META_FETCH_FAILED' // Server responded with an error to a resource request data fetch
export const RESOURCE_REQUEST_DATA_FETCH_STARTED = 'RESOURCE_REQUEST_DATA_FETCH_STARTED' // Resource request data fetch request was initiated
export const RESOURCE_REQUEST_DATA_FETCH_SUCCEEDED = 'RESOURCE_REQUEST_DATA_FETCH_SUCCEEDED' // Resource request data was successfuly fetched from the server
export const RESOURCE_REQUEST_DATA_FETCH_FAILED = 'RESOURCE_REQUEST_DATA_FETCH_FAILED' // Server responded with an error to a resource request data fetch
...
export const SCORING_WIZARD_PIPELINE_UPDATED = 'SCORING_WIZARD_PIPELINE_UPDATED'
...
export const SCORING_WIZARD_RECENT_DATA_TOGGLED = 'SCORING_WIZARD_RECENT_DATA_TOGGLED'
...
export const EXPLANATIONS_FETCH_REQUESTED = 'EXPLANATIONS_FETCH_REQUESTED'
export const EXPLANATIONS_FETCH_STARTED = 'EXPLANATIONS_FETCH_STARTED'
export const EXPLANATIONS_FETCH_SUCCEEDED = 'EXPLANATIONS_FETCH_SUCCEEDED'
export const EXPLANATIONS_FETCH_FAILED = 'EXPLANATIONS_FETCH_FAILED'
export const EXPLANATIONS_CLEARED = 'EXPLANATIONS_CLEARED'
export const EXPLANATIONS_OUTDATED = 'EXPLANATIONS_OUTDATED'
export const EXPLANATIONS_EXPIRED = 'EXPLANATIONS_EXPIRED'

export const LOGS_FETCH_STARTED = 'LOGS_FETCH_STARTED' // Logs fetch started
export const LOGS_FETCH_SUCCEEDED = 'LOGS_FETCH_SUCCEEDED' // Logs fetch succeeded
export const LOGS_FETCH_FAILED = 'LOGS_FETCH_FAILED' // Logs fetch failed
export const LOGS_CLEARED = 'LOGS_CLEARED' // Logs cleared

export const PLANS_FETCH_STARTED = 'PLANS_FETCH_STARTED'
export const PLANS_FETCH_SUCCEEDED = 'PLANS_FETCH_SUCCEEDED'
export const PLANS_FETCH_FAILED = 'PLANS_FETCH_FAILED'
export const ASSETS_FETCH_STARTED = 'ASSETS_FETCH_STARTED'
export const ASSETS_FETCH_SUCCEEDED = 'ASSETS_FETCH_SUCCEEDED'
...
export const USER_PERMISSIONS_FETCH_STARTED = 'USER_PERMISSIONS_FETCH_STARTED'
export const USER_PERMISSIONS_FETCH_SUCCEEDED = 'USER_PERMISSIONS_FETCH_SUCCEEDED'
export const USER_PERMISSIONS_FETCH_FAILED = 'USER_PERMISSIONS_FETCH_FAILED'

export const SYSTEM_PERMISSIONS_FETCH_STARTED = 'SYSTEM_PERMISSIONS_FETCH_STARTED'
export const SYSTEM_PERMISSIONS_FETCH_SUCCEEDED =
  'SYSTEM_PERMISSIONS_FETCH_SUCCEEDED'
export const SYSTEM_PERMISSIONS_FETCH_FAILED = 'SYSTEM_PERMISSIONS_FETCH_FAILED'
export const SYSTEM_PERMISSIONS_CLEARED = 'SYSTEM_PERMISSIONS_CLEARED'
export const SYSTEM_PERMISSIONS_OUTDATED = 'SYSTEM_PERMISSIONS_OUTDATED'
export const SYSTEM_PERMISSIONS_EXPIRED = 'SYSTEM_PERMISSIONS_EXPIRED'

export const LICENCES_FETCH_STARTED = 'LICENCES_FETCH_STARTED'
export const LICENCES_FETCH_SUCCEEDED = 'LICENCES_FETCH_SUCCEEDED'
export const LICENCES_FETCH_FAILED = 'LICENCES_FETCH_FAILED'
export const LICENCES_CLEARED = 'LICENCES_CLEARED'
export const LICENCES_OUTDATED = 'LICENCES_OUTDATED'
export const LICENCES_EXPIRED = 'LICENCES_EXPIRED'

export const CONTRACTS_FETCH_STARTED = 'CONTRACTS_FETCH_STARTED'
export const CONTRACTS_FETCH_SUCCEEDED = 'CONTRACTS_FETCH_SUCCEEDED'
export const CONTRACTS_FETCH_FAILED = 'CONTRACTS_FETCH_FAILED'
export const CONTRACTS_CLEARED = 'CONTRACTS_CLEARED'
export const CONTRACTS_OUTDATED = 'CONTRACTS_OUTDATED'
export const CONTRACTS_EXPIRED = 'CONTRACTS_EXPIRED'
export const CHARGEBEE_PORTAL_REQUEST_STARTED = 'CHARGEBEE_PORTAL_REQUEST_STARTED'
export const CHARGEBEE_PORTAL_REQUEST_SUCCEEDED = 'CHARGEBEE_PORTAL_REQUEST_SUCCEEDED'
export const CHARGEBEE_PORTAL_REQUEST_FAILED = 'CHARGEBEE_PORTAL_REQUEST_FAILED'

export const PAYMENTS_FETCH_STARTED = 'PAYMENTS_FETCH_STARTED'
...
export const PAYMENTS_OUTDATED = 'PAYMENTS_OUTDATED'
export const PAYMENTS_EXPIRED = 'PAYMENTS_EXPIRED'

export const AUTOMATIONS_FETCH_STARTED = 'AUTOMATIONS_FETCH_STARTED'
export const AUTOMATIONS_FETCH_SUCCEEDED = 'AUTOMATIONS_FETCH_SUCCEEDED'
export const AUTOMATIONS_FETCH_FAILED = 'AUTOMATIONS_FETCH_FAILED'
export const AUTOMATIONS_CLEARED = 'AUTOMATIONS_CLEARED'
export const AUTOMATIONS_OUTDATED = 'AUTOMATIONS_OUTDATED'
export const AUTOMATIONS_EXPIRED = 'AUTOMATIONS_EXPIRED'